...
import { fetchCategories, fetchProductsByCategory } from "../api/axios";
                  ...
                  <div className="grid grid-cols-4 gap-6 max-h-[600px] overflow-y-auto">
                    {products.map((product) => (
                      <div
                        ...
                        className="bg-white shadow-lg p-4 rounded-lg transform hover:scale-105 transition"
                      >
                        <img
                  ...
                  {cart.length === 0 ? (
                    ...
                    <div>
                      ...
                      <div className="mt-4">
                        ...
                        <button className="w-full bg-blue-600 text-white py-2 px-4 mt-4 rounded hover:bg-blue-700 transition">
                          Checkout
                        </button>
                      </div>
                    </div>
