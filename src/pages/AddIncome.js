      ...
      <div className="min-h-screen bg-white text-gray-900 p-4 md:p-6">
        <div className="w-full">
          <div className="flex items-center mb-6">
            ...
            <h2 className="text-2xl md:text-3xl font-bold text-gray-800">Add Income</h2>
          </div>
          ...
          {success && (
            <div className="mb-4 md:mb-6 p-3 md:p-4 bg-green-100 border-l-4 border-green-500 text-green-700 rounded">
              <div className="flex items-center">
                ...
                <span className="text-sm md:text-base"><strong>Success!</strong> Income added successfully. Redirecting...</span>
              </div>
            </div>
          )}
