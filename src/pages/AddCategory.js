        ...
        <div className="w-full">
          <div className="flex items-center mb-6">
            <div className="bg-indigo-600 p-2 md:p-3 rounded-full mr-3 md:mr-4">
              <FaPlusCircle className="text-white text-lg md:text-xl" />
            </div>
          ...
          {success && (
            <div className="mb-4 md:mb-6 p-3 md:p-4 bg-green-100 border-l-4 border-green-500 text-green-700 rounded">
              <div className="flex items-center">
                ...
                <span className="text-sm md:text-base"><strong>Success!</strong> Category added successfully. Redirecting...</span>
              </div>
            </div>
          )}
